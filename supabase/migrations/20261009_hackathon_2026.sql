...
CREATE TABLE IF NOT EXISTS public.hackathon_settings (
    ...
    early_bird_price NUMERIC NOT NULL DEFAULT 149,
    regular_price NUMERIC NOT NULL DEFAULT 249,
    last_minute_price NUMERIC NOT NULL DEFAULT 299,
    ...
    upi_id TEXT NOT NULL DEFAULT '7416201359@ybl',
